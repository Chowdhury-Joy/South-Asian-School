...
document.addEventListener('DOMContentLoaded', ()=>
{
          ...
          tl.to('.bannerImg', {opacity: 0.8,duration: 1, xPercent: 0})
          .to('#scrldwn01', {opacity: 1,duration: 1, y: -50})
          .to('.scrl-stagger', 2, {opacity: 1, y: 50, ease: Expo.easeInOut, stagger: 0.5},"<")
